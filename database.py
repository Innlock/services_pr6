...
services_data2 = [
    ["Услуги администрирования", "Обработка",
     "Управление контентом; Мониторинг производительности; SEO оптимизация; Техническая поддержка.", "technical"],
    ["Услуги администрирования", "Хранение",
     "Резервное копирование данных; Хранение шаблонов исходных файлов; Управление хостингом и доменом.", "technical"],
    ["Услуги создания", "Дизайн",
     "Исследование требований клиента; Создание концепции дизайна;" +
     " Разработка макетов веб-сайта; Разработка иконок и графики.", "technical"],
    ["Услуги создания", "Разработка",
     "Создание прототипа сайта; Разработка бэкэнда; Разработка фронтенда;" +
     " Разработка базы данных; Развертка сайта на сервере.", "technical"],
    ["Услуги создания", "Проектирование",
     "Изучение бизнеса заказчика, его клиентов и конкурентов; Разработка концепции сайта;" +
     " Создание технического задания; Создание архитектуры сайта.", "technical"],
]
users = [
    ["user1", "123", "employee"],
    ["user2", "123", "employee"],
...
tickets = [
    ['Помогите', 1, 'user123@com', 'Упал сервер', 1],
    ['Перезагрузка очистила базу', 2, 'user123@com', 'После перезагрузки сервера слетели данные учетки', 1]
]
